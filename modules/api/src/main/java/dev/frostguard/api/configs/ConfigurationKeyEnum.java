...
public enum ConfigurationKeyEnum {
    ...
    ALLIANCE_AUTOJOIN_POLAR_TERROR_BOOL                 ("true",    Boolean.class,  ConfigCategory.ALLIANCE),
    ALLIANCE_AUTOJOIN_GINAS_REVENGE_BOOL                ("true",    Boolean.class,  ConfigCategory.ALLIANCE),
    ALLIANCE_AUTOJOIN_MERCENARY_PRESTIGE_BOOL           ("true",    Boolean.class,  ConfigCategory.ALLIANCE),
    ALLIANCE_AUTOJOIN_SKIP_MAXED_BOOL                   ("true",    Boolean.class,  ConfigCategory.ALLIANCE),
    ALLIANCE_AUTOJOIN_PHANTHERA_BOOL                    ("true",    Boolean.class,  ConfigCategory.ALLIANCE),
    ...
    ALLIANCE_HELP_MAX_COUNT_INT                         ("15",      Integer.class,  ConfigCategory.ALLIANCE),
    ALLIANCE_HELP_TIME_REDUCTION_SEC_INT                ("210",     Integer.class,  ConfigCategory.ALLIANCE),
    ...
    HOSPITAL_HEAL_ENABLED_BOOL                  ("false",   Boolean.class,  ConfigCategory.CITY),
    HOSPITAL_HEAL_FIELD_ENABLED_BOOL            ("true",    Boolean.class,  ConfigCategory.CITY),
    HOSPITAL_HEAL_CITY_ENABLED_BOOL             ("false",   Boolean.class,  ConfigCategory.CITY),
    HOSPITAL_HEAL_TARGET_TIER_INT               ("0",       Integer.class,  ConfigCategory.CITY),
    HOSPITAL_HEAL_MAX_WAIT_MINUTES_INT          ("30",      Integer.class,  ConfigCategory.CITY),
    HOSPITAL_HEAL_USE_SPEEDUP_BOOL              ("false",   Boolean.class,  ConfigCategory.CITY),
    HOSPITAL_HEAL_MAX_SPEEDUP_MINUTES_INT       ("60",      Integer.class,  ConfigCategory.CITY),
    ...
    /** Legacy keys retained so existing persisted profiles can still be read without IllegalArgumentException. */
    BEAST_HUNTING_AUTO_ATTACK_MAX_LEVEL_BOOL    ("false",   Boolean.class,       ConfigCategory.EVENTS, true),
    BEAST_HUNTING_MAX_ATTACKS_INT               ("10",      Integer.class,       ConfigCategory.EVENTS, true),
    BEAST_HUNTING_USE_STAMINA_ITEMS_BOOL        ("false",   Boolean.class,       ConfigCategory.EVENTS, true),
    BEAST_HUNTING_STAMINA_ITEM_RESERVE_INT      ("0",       Integer.class,       ConfigCategory.EVENTS, true),
    BEAST_HUNTING_MARCH_1_FLAG_STRING           ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAST_HUNTING_MARCH_2_FLAG_STRING           ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAST_HUNTING_MARCH_3_FLAG_STRING           ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAST_HUNTING_MARCH_4_FLAG_STRING           ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAST_HUNTING_MARCH_5_FLAG_STRING           ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAST_HUNTING_MARCH_6_FLAG_STRING           ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAR_TRAP_JOIN_MARCH_1_FLAG_STRING          ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAR_TRAP_JOIN_MARCH_2_FLAG_STRING          ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAR_TRAP_JOIN_MARCH_3_FLAG_STRING          ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAR_TRAP_JOIN_MARCH_4_FLAG_STRING          ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAR_TRAP_JOIN_MARCH_5_FLAG_STRING          ("No Flag", String.class,        ConfigCategory.EVENTS, true),
    BEAR_TRAP_JOIN_MARCH_6_FLAG_STRING          ("No Flag", String.class,        ConfigCategory.EVENTS, true),
