...
public enum ConfigurationKeyEnum {
    ...
    BEAST_HUNTING_AUTO_ATTACK_MAX_LEVEL_BOOL    ("false",   Boolean.class,  ConfigCategory.INTEL),
    BEAST_HUNTING_MAX_ATTACKS_INT               ("10",      Integer.class,  ConfigCategory.INTEL),
    BEAST_HUNTING_USE_STAMINA_ITEMS_BOOL        ("false",   Boolean.class,  ConfigCategory.INTEL),
    BEAST_HUNTING_STAMINA_ITEM_RESERVE_INT      ("0",       Integer.class,  ConfigCategory.INTEL),
    BEAST_HUNTING_MARCH_1_FLAG_STRING           ("No Flag", String.class,   ConfigCategory.INTEL),
    BEAST_HUNTING_MARCH_2_FLAG_STRING           ("No Flag", String.class,   ConfigCategory.INTEL),
    BEAST_HUNTING_MARCH_3_FLAG_STRING           ("No Flag", String.class,   ConfigCategory.INTEL),
    BEAST_HUNTING_MARCH_4_FLAG_STRING           ("No Flag", String.class,   ConfigCategory.INTEL),
    BEAST_HUNTING_MARCH_5_FLAG_STRING           ("No Flag", String.class,   ConfigCategory.INTEL),
    BEAST_HUNTING_MARCH_6_FLAG_STRING           ("No Flag", String.class,   ConfigCategory.INTEL),
